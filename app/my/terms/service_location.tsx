...
const locationData = [
  {
    title: "제1조 (목적)",
    content:
      "본 약관은 회원('마이코드' 서비스 약관에 동의한 개인위치정보주체를 말합니다. 이하 '회원'이라고 합니다.)이 '마이코드'(이하 '회사'라고 합니다.)가 제공하는 '마이코드' 서비스(이하 '서비스'라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 기타 필요한 사항을 규정함을 목적으로 합니다.",
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "⑤ 제3항에도 불구하고 회원은 위치정보법 시행령 제24조에 따라 정보제공내역을 (7일마다 또는 1회씩) 모아서 통보받는 방법을 선택할 수 있으며, 회원이 회사의 절차에 따라 요청할 경우 전항에 따른 즉시 통보 방법으로 변경할 수 있습니다.",
  ...
  {
    title: "제9조 (개인위치정보의 이용 또는 제공의 제한)",
    content:
  ...
  {
    title: "제10조 (개인위치정보주체의 권리 및 행사방법)",
    items: [
  ...
  {
    title: "제12조 (8세 이하의 아동 등의 보호의무자의 권리･의무 및 행사방법)",
    items: [
      ...
      <ScrollView className="flex-1 px-5 py-6">
        {locationData.map((section, index) => (
          <View key={index} className="mb-6">
            {/* 조항 제목 */}
            <View className="mb-3 border-l-4 border-[#6C4DFF] pl-3">
        ...
        {/* 부칙 */}
        <View className="mt-4 rounded-lg bg-[#F5F3FF] p-4">
          <Text className="text-center text-sm font-semibold text-[#6C4DFF]">
            부칙
          </Text>
          <Text className="mt-2 text-center text-sm text-gray-700">
            이 약관은 2025. 8. 15. 부터 시행합니다.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
