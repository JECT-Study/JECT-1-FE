...
const termsData = [
  {
    title: "제1조 목적",
    content:
      '본 이용약관은 "마이코드"(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.',
  },
  {
    title: "제2조 용어의 정의",
